...
class ProductController extends Controller
{
    ...
    public function showCreateForm() {
        ...
        return view('product.create', compact('categories', 'zones', 'storacks'));
    }
    ...
    public function showUpdateForm($id) {
        ...
        $zones = Zone::all();
        $storacks = Storack::with('rack')->get();
        return view('product.update', compact('product', 'categories', 'zones', 'storacks'));
    }
    ...
    public function destroy($id) {
        ...
        return redirect()->route('product.list')->with('success', 'Product and its barcode deleted successfully.');
    }
}
