...
class CategoryController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            return view('category_mappings.cat_categories.dashboard', compact('categories'));
    ...
    public function create() {
        return view('category_mappings.cat_categories.create');
    }
    ...
    public function edit($id) {
        ...
        return view('category_mappings.cat_categories.update', compact('category'));
    }
