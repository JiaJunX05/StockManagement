...
class MappingController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            return view('category_mappings.cat_mappings.dashboard', compact('categories', 'subcategories'));
        } catch (\Exception $e) {
    ...
    public function create() {
        $categories = Category::all();
        $subcategories = SubCategory::all();
        return view('category_mappings.cat_mappings.create', compact('categories', 'subcategories'));
    }
    ...
    public function edit($id) {
        ...
        $categories = Category::all();
        $subcategories = SubCategory::all();
        return view('category_mappings.cat_mappings.update', compact('mapping', 'categories', 'subcategories'));
    }
