...
class CategoryController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            return view('category_mapping.category.dashboard', compact('categories'));
    ...
    public function create() {
        return view('category_mapping.category.create');
    }
    ...
    public function edit($id) {
        ...
        return view('category_mapping.category.update', compact('category'));
    }
