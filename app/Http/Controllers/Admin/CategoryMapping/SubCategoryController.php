...
class SubCategoryController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            return view('category_mapping.subcategory.dashboard', compact('subCategories'));
    ...
    public function create() {
        return view('category_mapping.subcategory.create');
    }
    ...
    public function edit($id) {
        ...
        return view('category_mapping.subcategory.update', compact('subcategory'));
    }
