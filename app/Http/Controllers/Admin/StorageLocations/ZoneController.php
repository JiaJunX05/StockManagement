...
class ZoneController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            $zones = Zone::all();
            return view('storage_locations.stg_zones.dashboard', compact('zones'));
    ...
    public function create() {
        return view('storage_locations.stg_zones.create');
    }
    ...
    public function edit($id) {
        ...
        return view('storage_locations.stg_zones.update', compact('zone'));
    }
