...
class LocationController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            $zones = Zone::all();
            $racks = Rack::all();
            return view('storage_locations.stg_locations.dashboard', compact('zones', 'racks'));
        } catch (\Exception $e) {
    ...
    public function create() {
        $zones = Zone::all();
        $racks = Rack::all();
        return view('storage_locations.stg_locations.create', compact('zones', 'racks'));
    }
    ...
    public function edit($id) {
        ...
        $zones = Zone::all();
        $racks = Rack::all();
        return view('storage_locations.stg_locations.update', compact('location', 'zones', 'racks'));
    }
