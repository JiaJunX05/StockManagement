...
class SubCategoryController extends Controller
{
    public function index(Request $request) {
        try {
            ...
            return view('master.category.subcategory.dashboard', compact('subCategories'));
    ...
    public function create() {
        return view('master.category.subcategory.create');
    }
    ...
    public function edit($id) {
        ...
        return view('master.category.subcategory.update', compact('subcategory'));
    }
