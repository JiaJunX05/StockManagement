        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold">Create Rack</h4>
                        <p class="text-muted mb-0">Add a new rack to organize and manage stock storage efficiently</p>
                    </div>
                </div>
                    ...
                    <form action="{{ route('rack.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" class="form-control border-start-0" id="rack_image" name="rack_image" required>
                            </div>
                            <div class="form-text">
...
<script>
    ...
    const input = document.querySelector('#rack_image');           // 文件上传的 <input>
