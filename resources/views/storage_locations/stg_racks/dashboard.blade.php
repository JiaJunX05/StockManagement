        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table custom-table mb-0">
                    ...
                    <tbody id="table-body"
                        data-url="{{ route('rack.index') }}"
                        data-edit-url="{{ route('rack.edit', ['id' => ':id']) }}"
                        data-delete-url="{{ route('rack.destroy', ['id' => ':id']) }}">
                    </tbody>
                    <div id="no-results" class="text-center py-3" style="display: none;">
                        <div class="text-muted">No racks found</div>
                    </div>
                </table>
            </div>
        </div>
...
@section("scripts")
    <script src="{{ asset('assets/js/rack-dashboard.js') }}"></script>
@endsection