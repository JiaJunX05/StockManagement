        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold">Update Zone</h4>
                        <p class="text-muted mb-0">Modify existing zone information</p>
                    </div>
                </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    <!-- 表单标题 -->
                    <h2 class="text-primary text-center mb-3">Update Zone</h2>
                    <p class="text-muted text-center">Modify zone information to better manage stock locations</p>
                    <hr>
                    ...
                    <form action="{{ route('zone.update', $zone->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="input_image" class="form-label fw-bold">Zone Image</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-upload text-primary"></i></span>
                                <input type="file" class="form-control border-start-0" id="input_image" name="zone_image">
                            </div>
                            <div class="form-text">
