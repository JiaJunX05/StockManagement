        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold">Create Location</h4>
                        <p class="text-muted mb-0">Efficiently manage and organize storage racks within designated zones</p>
                    </div>
                </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    <!-- 表单标题 -->
                    <h2 class="text-primary text-center mb-3">Create Location</h2>
                    <p class="text-muted text-center">Efficiently manage and organize storage racks within designated zones</p>
                    <hr>
                    ...
                    <form action="{{ route('location.store') }}" method="post">
                        ...
                        <button type="submit" class="btn btn-primary w-100">
                            <i class="bi bi-plus-circle-fill me-2"></i>Create Location
                        </button>
                    </form>
                </div>
            </div>
