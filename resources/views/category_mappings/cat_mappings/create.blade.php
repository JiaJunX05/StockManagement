        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold">Create Category Mapping</h4>
                        <p class="text-muted mb-0">Create relationships between categories and subcategories</p>
                    </div>
                </div>
                ...
                <div class="preview-section d-flex flex-column h-100 bg-light p-3">
                    ...
                    <div class="preview-container flex-grow-1 d-flex align-items-center justify-content-center">
                        <div class="text-center">
                            ...
                            <p class="text-muted mt-3">Category-SubCategory Relationship</p>
                        </div>
                    </div>
                </div>
            </div>
