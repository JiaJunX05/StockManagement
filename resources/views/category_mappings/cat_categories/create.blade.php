            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">Add a new category to organize and manage products</p>
                    </div>
                </div>
        ...
        <div class="row g-0">
                ...
                <div class="preview-section d-flex flex-column h-100 bg-light p-3">
                    ...
                    <div class="preview-container flex-grow-1 d-flex align-items-center justify-content-center">
                        <div class="text-center">
                            ...
                            <p class="text-muted mt-3">Upload Category Image</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-7">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted text-center">Add a new category to organize and manage products</p>
                    <hr>
                    ...
                    <form action="{{ route('category.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="input_image" class="form-label fw-bold">Category Image</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0"><i class="bi bi-upload text-primary"></i></span>
                                <input type="file" class="form-control border-start-0" id="input_image" name="category_image" required>
                            </div>
                            <div class="form-text">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0" id="category_name" name="category_name" placeholder="Enter category name" required>
                            </div>
                        </div>
