                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('color.store') }}" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <!-- 添加颜色预览区域 -->
                            <div class="mt-3">
                                <div class="color-preview" id="color-preview" style="width: 100%; height: 60px; border-radius: 8px; background-color: #f3f4f6; border: 1px solid #e5e7eb;"></div>
                            </div>
                        </div>
...
@section("scripts")
    <script src="{{ asset('assets/js/color-create.js') }}"></script>
@endsection
